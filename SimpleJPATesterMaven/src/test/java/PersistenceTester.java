...
public class PersistenceTester {
    ...
    private final String PERSISTENCE_UNIT_NAME = "SimpleJPATesterMavenPU";
    ...
    public void testGenrePersisting() {
        ...
        assertTrue(allGenres.size() == 1);

        Genre actionFromDB = (Genre) allGenres.get(0);
        assertEquals(action.getDescription(), actionFromDB.getDescription());
    }
